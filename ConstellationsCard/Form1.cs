///Made by Sam Wyatt as the first summative assignment in ICS3U, Due date: 29 September 2016. The program uses sounds
///and flashing colours to display the constellation Leo.
using System;
...
namespace ConstellationsCard
{
    public partial class stars : Form
    {
        ...
        private void stars_Click(object sender, EventArgs e)
        {
            ...
            stars.DrawString("By: Sam Wyatt              Date: 29 September 2016", nameFont, whiteBrush, 80, 430);

            //Pause for 5 secounds 
            Thread.Sleep(5000);
            ...
            //Change blackBrush to red so another brush does not have to be made
            blackBrush.Color = Color.Red; 

            //Complete the flashing star animation 
            ...
            stars.FillEllipse(whiteBrush, 82, 248, 5, 5);
            Thread.Sleep(500);
            sounds = new SoundPlayer(Properties.Resources.upBeep2);
            sounds.Play();

            Thread.Sleep(1000);

            //Change whitePen and whiteBrush to red so another brush and pen don't have to be made
            ...
            //Change whitePen and whiteBrush to orange so another brush and pen don't have to be made
            whitePen.Color = Color.OrangeRed;
            whiteBrush.Color = Color.OrangeRed;

            //Orange Leo Animation
            stars.DrawLine(whitePen, 88, 250, 198, 172);
            stars.FillEllipse(whiteBrush, 82, 248, 5, 5);
            Thread.Sleep(30);
            stars.DrawLine(whitePen, 88, 250, 196, 244);
